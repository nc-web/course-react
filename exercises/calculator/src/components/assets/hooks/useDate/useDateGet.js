...
// Hooks Date Get Format Name Spanish
export const useDateGetFormatNameES = () => {
  const dateTemp = new Date()
...
// Hooks Date Get Format Name Spanish
export const useDateGetFormatNameDayPlusES = () => {
  const dateTemp = new Date()
  const day = dateTemp.getDay()
  const date = dateTemp.getDate()
  const month = dateTemp.getMonth()
...
export const useDateGetFormatNameEN = () => {
  const dateTemp = new Date()
  const day = dateTemp.getDay()
  const date = dateTemp.getDate()
  const month = dateTemp.getMonth()
...
// Hooks Date Get Format Name English
export const useDateGetFormatNameDayPlusEN = () => {
  const dateTemp = new Date()
  const day = dateTemp.getDay()
  const date = dateTemp.getDate()
  const month = dateTemp.getMonth()
