...
import {
  ...
  AlignContentFlexStart, AlignContentFlexCenter, AlignContentFlexEnd, AlignContentSpaceAround, AlignContentSpaceBetween, AlignContentStretch,
  AlignItemsFlexStart, AlignItemsCenter, AlignItemsFlexEnd, AlignItemsStretch, AlignItemsBaseline,
  AlignSelfFlexStart, AlignSelfCenter, AlignSelfFlexEnd, AlignSelfStretch, AlignSelfBaseline, AlignSelfAuto,
  ...
  JustifyContenFlexStart, JustifyContenCenter, JustifyContenFlexEnd, JustifyContenSpaceAround, JustifyContenSpaceBetween, JustifyContenSpaceEvely
...
const ncProps = css`
    ...
    /* ALIGN CONTENT */
    ${props => props.acFlexStart && css` ${AlignContentFlexStart}`}
    ${props => props.acCenter && css` ${AlignContentFlexCenter} `}
    ${props => props.acFlexEnd && css` ${AlignContentFlexEnd} `}
    ${props => props.acSpaceAround && css` ${AlignContentSpaceAround} `}
    ${props => props.acSpaceBetween && css` ${AlignContentSpaceBetween} `}
    ${props => props.acStretch && css` ${AlignContentStretch} `}

    /* ALIGN ITEMS */
    ${props => props.aiFlexStart && css` ${AlignItemsFlexStart} `}
    ${props => props.aiCenter && css` ${AlignItemsCenter} `}
    ${props => props.aiFlexEnd && css` ${AlignItemsFlexEnd} `}
    ${props => props.aiStretch && css` ${AlignItemsStretch} `}
    ${props => props.aiBaseline && css` ${AlignItemsBaseline} `}

    /* ALIGN SELF */
    ${props => props.asFlexStart && css` ${AlignSelfFlexStart} `}
    ${props => props.asCenter && css` ${AlignSelfCenter} `}
    ${props => props.asFlexEnd && css` ${AlignSelfFlexEnd} `}
    ${props => props.asStretch && css` ${AlignSelfStretch} `}
    ${props => props.asBaseline && css` ${AlignSelfBaseline} `}
    ${props => props.asAuto && css` ${AlignSelfAuto} `}
    ...
    /* JUSTIFY CONTENT */
    ${props => props.justifyContentFlexStart && css` ${JustifyContenFlexStart} `}
    ${props => props.justifyContentCenter && css` ${JustifyContenCenter} `}
    ${props => props.justifyContentFlexEnd && css` ${JustifyContenFlexEnd}`}
    ${props => props.justifyContentSpaceAround && css` ${JustifyContenSpaceAround} `}
    ${props => props.justifyContentSpaceBetween && css` ${JustifyContenSpaceBetween} `}
    ${props => props.justifyContentSpaceEvely && css` ${JustifyContenSpaceEvely} `}

`

export default ncProps
