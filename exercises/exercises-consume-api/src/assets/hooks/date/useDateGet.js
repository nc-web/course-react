...
export const useDateFormat = (dateExt) => {
...
// Hooks Date Get Format Name Spanish
export const useDateFormatNameES = (dateExt) => {
...
// Hooks Date Get Format Name Spanish
export const useDateFormatNameDayPlusES = (dateExt) => {
...
export const useDateFormatNameEN = (dateExt) => {
...
// Hooks Date Get Format Name English
export const useDateFormatNameDayPlusEN = (dateExt) => {
